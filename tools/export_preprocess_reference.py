...
def export_reference(repo: Path, audio: Path, out_dir: Path) -> dict:
    ...
    input_header = f"""#ifndef BIRDHOUSE_REFERENCE_INPUT_INT8_H_
...
// Reference model input generated by Python preprocessing.
// Source audio:
//   {audio}
...
"""
    (out_dir / "reference_input_int8.h").write_text(input_header, encoding="utf-8")

    pcm_header = f"""#ifndef BIRDHOUSE_REFERENCE_PCM_FLOAT32_H_
#define BIRDHOUSE_REFERENCE_PCM_FLOAT32_H_
...
// Reference 5-second, 16 kHz, mono PCM generated by Python/librosa.
// Source audio:
//   {audio}
// This array is intentionally large and should only be used for firmware
// smoke/integration tests. It is not part of the final live microphone path.
constexpr size_t kReferencePcmFloat32Length = kTargetSamples;

const float kReferencePcmFloat32[kReferencePcmFloat32Length] = {{
{format_float_array(pcm)}
}};

}}  // namespace birdhouse

#endif  // BIRDHOUSE_REFERENCE_PCM_FLOAT32_H_
"""
    (out_dir / "reference_pcm_float32.h").write_text(pcm_header, encoding="utf-8")
    ...
    summary = {
        ...
        "files": {
            ...
            "reference_pcm_float32_h": str((out_dir / "reference_pcm_float32.h").relative_to(repo)),
